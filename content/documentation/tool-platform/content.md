...
*Theia extensions*, on the other hand, are more powerful than VS Code extensions and allow you to deeply customize all aspects tool platform, including the workbench structure, e.g. by adding a global toolbar, remove user interface components that you don't need in your particular tool, add wizards in the frontend or custom backend services.
...
When you want to package your custom tool as a desktop application, you'll need to build your enitre application for the operating systems you aim to support and likely want to integrate an update mechanism and add branding, such as application icons, etc.
